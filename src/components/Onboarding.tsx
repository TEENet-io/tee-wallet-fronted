      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="bg-surface-container-low rounded-2xl ghost-border p-6 space-y-5">
          <div className="space-y-1.5">
            <label className="text-xs font-medium text-on-surface-variant">Your name or email</label>
            <input
          ...
          >
            ...
            {loading ? 'Activating...' : 'Register with Passkey'}
          </button>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-surface-container-low text-on-surface-variant">or</span>
            </div>
          </div>
        ...
        <p className="text-center text-[11px] text-on-surface-variant">
          Secured by TEE hardware enclaves
        </p>
      </div>
    </div>
  );
